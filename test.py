...
def test_model(args):
    ...
    # load the test set
    datas, testLoader = build_dataset_test(args.dataset, args.num_workers,args.test_nums)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str,
                        default="./checkpoint/camvid/IRDPnetbs16gpu1_trainval/model_7.pth",
    ...
    parser.add_argument("--test_nums",type=int ,default=20, help="Number of tset image")
